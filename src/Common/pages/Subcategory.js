...
function Subcategory() {
    const { isLiked, isAdded, allbookDetails, likedProducts, userIdShop, userIdLike, likescount, shopProducts, shopcount, minPrice, priceFilter, filteredProducts, productIdDetails, searchfield, subCategoryBook, filterCategory } = useSelector((state) => state.usedbookr_product)
    ...
    console.log("childcategory", childcategoryBook)
    console.log("childcategory", filterCategory)
