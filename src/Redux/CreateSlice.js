...
export const CrateSlice = createSlice({
    ...
    reducers: {
        ...
        setSingleBookDetails: (state, action) => {
            state.singleBookDetails = action.payload
        },
